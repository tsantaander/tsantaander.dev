...
export default function Sparkles() {
  return (
    <div className="h-[25rem] w-full bg-black flex flex-col items-center justify-center overflow-hidden rounded-md animate-fade-up delay-600 duration-500">
      <h1 className="md:text-7xl text-3xl lg:text-9xl font-bold text-center text-white relative z-20 !font-aldrich">
        tsantaander
      </h1>

...
const DotGrid: React.FC<DotGridProps> = ({
  ...
  const resolvedBaseColor = useMemo(() => {
    return theme === 'dark' ? darkBaseColor : baseColor;
  }, [baseColor, darkBaseColor, theme]);
  ...
  }, [proximity, baseColor, activeRgb, baseRgb, circlePath, resolvedBaseColor]);
  ...
  useEffect(() => {
    ...
    const onMove = (e: MouseEvent) => {
      if (isTouchDevice) return; // No hacer nada en dispositivos táctiles
